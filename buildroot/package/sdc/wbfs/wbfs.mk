...
define WBFS_INSTALL_TARGET_CMDS
	cd $(WBFS_DIR) && rsync -rlp --exclude=".empty" --exclude=".svn" wb_common/* $(TARGET_DIR)
	cd $(WBFS_DIR) && ./wb_common.sh $(TARGET_DIR)
	cd $(WBFS_DIR) && rsync -rlp --exclude=".empty" --exclude=".svn" $(BR2_SDC_PLATFORM)_basic/* $(TARGET_DIR)
