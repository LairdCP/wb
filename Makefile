...
msd45n_config msd50n_config msd-x86_config wb50n_rdvk_config reg50n_config reg45n_config reglwb_config reglwb5_config mfg60n-arm-eabi_config mfg60n-x86_config wb45n_legacy_config wb50n_legacy_config som60_config som60sd_config som60sd_mfg_config ig60_config bdimx6_config sterling_supplicant-x86_config sterling_supplicant-arm_config backports_config firmware_config summit_supplicant-arm-eabi_config summit_supplicant-x86_config mfg60n-arm-eabihf_config summit_supplicant-arm-eabihf_config: unpack.stamp
...
msd45n msd-x86 msd50n wb50n_rdvk reg45n reg50n reglwb reglwb5 mfg60n-arm-eabi mfg60n-x86 wb45n_legacy wb50n_legacy som60 som60sd ig60 som60sd_mfg ig60 backports firmware sterling_supplicant-x86 sterling_supplicant-arm summit_supplicant-arm-eabi summit_supplicant-arm-eabihf summit_supplicant-x86 mfg60n-arm-eabihf: unpack.stamp
...
clean-wb45n_legacy clean-wb50n_legacy clean-msd45n clean-msd50n clean-wb50n_rdvk clean-msd-x86 clean-reg45n clean-reg50n clean-reglwb clean-reglwb5 clean-mfg60n-arm-eabi clean-mfg60n-x86 clean-som60 clean-som60sd clean-som60sd_mfg clean-ig60 clean-bdimx6 clean-backports clean-firmware clean-sterling_supplicant-x86 clean-sterling_supplicant-arm clean-summit_supplicant-arm-eabi clean-summit_supplicant-x86 clean-mfg60n-arm-eabihf clean-summit_supplicant-arm-eabihf:
...
clean:  clean-msd45n clean-msd50n clean-msd-x86 clean-firmware \
	...
	clean-reg45n clean-reg50n clean-reglwb clean-reglwb5 clean-mfg60n-arm-eabi clean-mfg60n-x86 clean-wb45n_legacy \
	clean-wb50n_legacy clean-som60 clean-som60sd clean-som60sd_mfg clean-ig60 clean-bdimx6 clean-mfg60n-arm-eabihf clean-summit_supplicant-arm-eabihf
...
.PHONY: default all clean cleanall source-wb45n_legacy msd50n wb50n_rdvk reg45n reg50n linux-docs\
	reglwb reglwb5 mfg60n-arm-eabi mfg60n-x86 bdimx6 source-wb50n_legacy msd-x86 backports clean-msd45n clean-msd50n \
	clean-msd-x86 clean-wb50n_rdvk clean-reg45n clean-reg50n clean-reglwb clean-reglwb5 clean-firmware \
	clean-mfg60n-arm-eabi clean-mfg60n-x86 clean-wb45n_legacy clean-wb50n_legacy clean-bdimx6 clean-backports som60 \
	clean-som60 som60sd clean-som60sd som60sd_mfg clean-som60sd_mfg ig60 clean-ig60 prune-workspace clean-mfg60n-arm-eabihf mfg60n-arm-eabihf
