...
msd45n_config msd50n_config wb45n_config wb45n_devel_config msd-x86_config wb50n_config wb50n_devel_config wb50n_rdvk_config wb50n_rdvk_devel_config reg45n_config reg50n_config reglwb_config reglwb5_config mfg60n_config wb45n_legacy_config wb45n_legacy_devel_config wb50n_legacy_config wb50n_legacy_devel_config sterling_supplicant-x86_config sterling_supplicant-arm_config: unpack.stamp
...
clean: clean-wb45n clean-wb45n_devel clean-wb50n clean-wb50n_devel clean-msd45n clean-msd50n clean-msd-x86 \
	clean-sterling_supplicant-x86 clean-sterling_supplicant-arm \
	clean-reg45n clean-reg50n clean-reglwb clean-reglwb5 clean-mfg60n clean-wb45n_legacy clean-wb45n_legacy_devel clean-wb50n_legacy clean-wb50n_legacy_devel
...
.PHONY: default all clean cleanall clean-wb45n wb45n \
        ...
        msd50n wb50n wb50n_devel wb50n_rdvk wb50n_rdvk_devel reg45n reg50n reglwb  reglwb5 mfg60n source-wb50n legal-info-wb50n \
        msd-x86 clean-wb50n-lrd-pkg clean-wb50n_devel-lrd-pkg clean-wb50n clean-wb50n_devel clean-msd45n \
        clean-msd50n clean-msd-x86 clean-wb50n_rdvk clean-wb50n_rdvk_devel clean-reg45n clean-reg50n clean-reglwb clean-reglwb5\
