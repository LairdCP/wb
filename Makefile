...
LAIRD_ARCHIVES_OPTIONAL := archive/msd50n-laird-3.5.5.10.tar.bz2 \
			   archive/msd45n-laird-3.5.5.10.tar.bz2 \
                           archive/msd40n-laird-3.5.5.10.tar.bz2
endif
...
msd40n_config msd45n_config msd50n_config wb40n_config wb45n_config wb45n_devel_config wb40n_devel_config msd-x86_config wb50n_config wb50n_devel_config wb50n_rdvk_config wb50n_rdvk_devel_config reg45n_config reg50n_config wb45n_legacy_config wb45n_legacy_devel_config wb50n_legacy_config wb50n_legacy_devel_config: unpack.stamp
...
msd40n msd45n wb40n wb45n wb45n_devel wb40n_devel msd-x86 msd50n wb50n_devel wb50n wb50n_rdvk wb50n_rdvk_devel reg45n reg50n wb45n_legacy wb45n_legacy_devel wb50n_legacy wb50n_legacy_devel: unpack.stamp
