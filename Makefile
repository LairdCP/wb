...
msd-x86 msd50n wb50n_rdvk reg50n reglwb reglwb5 mfg60n-arm-eabi mfg60n-x86 som60sd_mfg backports firmware sterling_supplicant-x86 sterling_supplicant-arm summit_supplicant-arm-eabi summit_supplicant-arm-eabihf summit_supplicant-x86: unpack.stamp
...
clean: clean-msd50n clean-msd-x86 clean-sterling_supplicant-x86 clean-sterling_supplicant-arm clean-backports clean-firmware \
	clean-reg50n clean-reglwb clean-reglwb5 clean-mfg60n-arm-eabi clean-mfg60n-x86 clean-wb50n_legacy clean-bdimx6 clean-som60 clean-som60sd clean-som60sd_mfg
