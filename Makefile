...
all: wb45n_legacy msd45n msd-x86 msd50n wb50n_legacy som60 ig60 bdimx6 backports firmware

msd45n_config msd50n_config msd-x86_config wb50n_rdvk_config reg50n_config reg45n_config reglwb_config reglwb5_config mfg60n_config wb45n_legacy_config wb50n_legacy_config som60_config som60sd_config som60sd_mfg_config ig60_config bdimx6_config sterling_supplicant-x86_config sterling_supplicant-arm_config backports_config firmware_config: unpack.stamp
...
msd45n msd-x86 msd50n wb50n_rdvk reg45n reg50n reglwb reglwb5 mfg60n wb45n_legacy wb50n_legacy som60 som60sd som60sd_mfg ig60 bdimx6 backports firmware sterling_supplicant-x86 sterling_supplicant-arm: unpack.stamp
...
clean-wb45n_legacy clean-wb50n_legacy clean-msd45n clean-msd50n clean-wb50n_rdvk clean-msd-x86 clean-reg45n clean-reg50n clean-reglwb clean-reglwb5 clean-mfg60n clean-som60 clean-som60sd clean-som60sd_mfg clean-ig60 clean-bdimx6 clean-backports clean-firmware clean-sterling_supplicant-x86 clean-sterling_supplicant-arm:
