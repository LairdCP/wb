...
msd45n msd-x86 msd50n wb50n_rdvk reg45n reg50n reglwb reglwb5 mfg60n mfg60n-x86 wb45n_legacy wb50n_legacy som60sd_mfg ig60 ig60sd_mfg backports firmware sterling_supplicant-x86 sterling_supplicant-arm summit_supplicant-arm summit_supplicant-x86: unpack.stamp
...
clean-wb45n_legacy clean-wb50n_legacy clean-msd45n clean-msd50n clean-wb50n_rdvk clean-msd-x86 clean-reg45n clean-reg50n clean-reglwb clean-reglwb5 clean-mfg60n clean-mfg60n-x86 clean-som60 clean-som60sd clean-som60sd_mfg clean-ig60 clean-ig60sd_mfg clean-bdimx6 clean-backports clean-firmware clean-sterling_supplicant-x86 clean-sterling_supplicant-arm clean-summit_supplicant-arm clean-summit_supplicant-x86:
...
clean:  clean-msd45n clean-msd50n clean-msd-x86 clean-firmware \
	...
	clean-wb50n_legacy clean-som60 clean-som60sd clean-som60sd_mfg clean-ig60 clean-ig60sd_mfg clean-bdimx6
...
.PHONY: default all clean cleanall source-wb45n_legacy msd50n wb50n_rdvk reg45n reg50n linux-docs\
	...
	clean-som60 som60sd clean-som60sd som60sd_mfg clean-som60sd_mfg clean-ig60 clean-ig60sd_mfg prune-workspace
