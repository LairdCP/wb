...
LAIRD_ARCHIVES_OPTIONAL := archive/msd50n-laird-3.5.2.3.tar.bz2 \
			   archive/msd45n-laird_fips-3.5.2.3.tar.bz2 \
                           archive/msd40n-laird-3.5.2.3.tar.bz2
endif
...
.PHONY: default all clean cleanall clean-wb40n clean-wb45n wb40n wb45n \
        ...
        msd50n wb50n wb50n_devel wb50n_rdvk source-wb50n legal-info-wb50n msd-x86 \
